...
export default function HallFunctionsPage() {
  ...
  const handleEdit = (eventId: number) => {
    ...
    router.push(`/notices/hall-functions/edit?id=${eventId}`);
  };
  ...
  const handleAddClick = () => {
    router.push('/notices/hall-functions/create');
  };
